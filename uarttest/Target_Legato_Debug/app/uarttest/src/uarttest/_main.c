...
// Startup code for the executable 'uarttest'.
...
LE_SHARED le_log_SessionRef_t uarttest_exe_LogSession;
LE_SHARED le_log_Level_t* uarttest_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    uarttest_exe_LogSession = log_RegComponent("uarttest_exe", &uarttest_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_uarttestComponent.so");
